...
<div>
  ...
  <div class="card app-calendar-wrapper">
    <div class="row g-0">
      ...
      <!-- /Calendar & Modal -->
      <div>
        <form id="testEventForm" wire:submit.prevent="testEvent">
          <!-- form fields -->
          <button type="submit" class="btn btn-primary btn-add-event me-sm-3 me-1">Add</button>
        </form>
      </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      let btnToggleSidebar = document.querySelector('.btn-toggle-sidebar');
      let addEventSidebar = document.getElementById('addEventSidebar');

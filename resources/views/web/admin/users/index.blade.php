...
@section('content')
    <div class="page-wrapper">
        @include('components._partials.page-title', ['pagetitle' => 'Users List', 'pretitle' => 'Users', 'posttitle' => 'Manage users from here.'])
                                ...
                                <td>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end m-0">
                                            ...
                                            <a {{-- Needs to be button because it is javascript --}}
                                               class="reset-password-button dropdown-item button"
                                               data-user-id="{{$user->id}}"
                      data-bs-toggle="modal" data-bs-target="#resetUserPassword-{{$user->id}}">Reset Password
                                            </a>
    ...
    @include('components.admin.users.reset-password-alert')

      ...
      <div class="w-px-400 mx-auto">
        ...
        <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="POST">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('username') is-invalid @enderror" id="login-username" name="username" placeholder="johndoe123" autofocus value="{{ old('username') }}">

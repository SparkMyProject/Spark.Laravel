...
class PermissionSeeder extends Seeder
{
  ...
  public function run(): void
  {
    ...
    Permission::create(['name' => 'actions.admin.users.edit-roles', 'description' => 'Edit user roles', 'is_system' => true]);
    ...
    Permission::create(['name' => 'actions.admin.settings.roles.delete', 'description' => 'Delete roles', 'is_system' => true]);
    Permission::create(['name' => 'actions.admin.settings.roles.create', 'description' => 'Create roles', 'is_system' => true]);
